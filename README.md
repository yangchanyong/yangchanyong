...
* Classic ASP / PHP 기반 Legacy Service Migration 및 CodeIgniter 전환
* IT Campus, MBC Beauty 등 서비스 Renewal 및 Backend 개발
* IDC → AWS Infrastructure Migration
* OAuth 2.0 기반 Social Login 및 Service API 개발
* Meta · Google · Naver Marketing API / Webhook Integration
* SQL Tuning 및 Query Optimization
* GitLab CI/CD · Jenkins 기반 Build / Deployment 운영
...
[Blog](https://c-uncle-full-stack.tistory.com/) · [Email](mailto:cksdydsla93@gmail.com)
